...
setup(
    name='Media Preflight API',
    version='0.0.1',
    license='GPLv3+',
    description=(
        'Preflight check for Open Broadcast audio-files'
    ),
    long_description=README,
    url='https://github.com/digris/media-preflight-api',
    ...
    entry_points={
        'console_scripts': [
            'media-preflight-api = app.runner:main',
        ],
    },
    tests_require=(
        'selenium',
